...
//                   className={`text-sm flex items-center gap-1.5 font-bold transition-all px-2.5 py-1 rounded-md ${location.pathname === '/admin'
...
export const Navbar = () => {
  ...
  // Load auth data when Navbar mounts
  ...
  return (
    <nav
      ...
      className="sticky top-0 z-50 bg-white/95 dark:bg-gray-950/95 backdrop-blur-md border-b border-gray-150/80 dark:border-gray-800 transition-colors duration-200"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link
              to="/"
              className="flex items-center gap-2 text-2xl font-black tracking-tight text-gray-950 dark:text-white"
            >
              <span className="text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 p-1.5 rounded-lg">
                <ShoppingBag className="h-6 w-6" />
              </span>
              ...
              <span className="text-emerald-500">
                ECO<span className="text-red-500">BAZAR</span>
              </span>
            </Link>
              ...
              <div className="relative">
                ...
                {profileOpen && (
                  ...
                  <div
                    ...
                    className="absolute right-0 mt-2 w-56 rounded-xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 py-2 shadow-xl ring-1 ring-black/5"
                  >
      ...
      {isOpen && (
        ...
        <div
          ...
          className="md:hidden border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-950 px-4 pt-2 pb-6 space-y-3 shadow-lg"
        >
            ...
            {isAuthenticated ? (
              ...
              <div className="grid grid-cols-2 gap-3 px-3">
                ...
                <Link
                  to="/login"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-center px-4 py-2.5 rounded-lg text-sm font-bold text-gray-700 border border-gray-200 dark:text-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800"
                >
                  Sign In
                </Link>
